...
class VlcPlayerController {
  ...
  /// Returns a list of ids of the PlatformViews that have been registered with this controller;
  /// Allows getting the id to register channels in a background Isolate
  List<int> get registeredViews => List<int>.unmodifiable(_registeredViews);
  List<int> _registeredViews = [];
